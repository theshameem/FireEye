...
# 			settings.BASE_DIR,'opencv_haarcascade_data/fire_detection_cascade_model.xml'))
...
#     recipientmail = "shameem.bzm@gmail.com" # recipients mail
...
#         server.ehlo()
#         server.starttls()
#         server.login("theshameem.alam@gmail.com", 'ZPShameem') # Senders mail ID and password
#         server.sendmail('theshameem.alam@gmail.com', recipientmail, "Warning fire accident has been reported") # recipients mail with mail message
